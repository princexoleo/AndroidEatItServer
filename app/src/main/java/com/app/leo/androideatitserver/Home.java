...
public class Home extends AppCompatActivity
   ...
   Uri saveUri;
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(newCategory !=null)
                {
                    ...
                    Snackbar.make(drawer,"New Categeroy "+newCategory.getName()+" was added in your database",Snackbar.LENGTH_SHORT).show();
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(Home.this, "Upload Successfully..!!", Toast.LENGTH_SHORT).show();
    ...
    private void loadMenu() {
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListner(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //click menu and send to the foodDetails activity
        ...
        adapter.notifyDataSetChanged();//Refresh data if any data changed
    ...
    }//for click on item and update / delete

    private void deleteCategory(String key) {
        categories.child(key).removeValue();
        Toast.makeText(this, "Item category Deleted !!", Toast.LENGTH_SHORT).show();
    }//for item delete
